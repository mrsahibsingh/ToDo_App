...
import sahib.todoapp.background.DatabaseClient;
import sahib.todoapp.background.Task;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.button_update).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(getApplicationContext(), "Updating Task", Toast.LENGTH_LONG).show();
                updateTask(task);
            }
        });
            ...
            public void onClick(View view) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(getApplicationContext(), "Deleting Task", Toast.LENGTH_LONG).show();
                        deleteTask(task);
                    }
                });
